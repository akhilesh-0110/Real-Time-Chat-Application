...
const Sidebar = () => {
  ...
  return (
    <>
      <aside className="h-full w-20 lg:w-72 dorder-r border-gray-200 flex flex-col transition-all duration-200 bg-white">
        {/* HEADER */}
        <div className="border-b border-gray-200 2-full p-5">
          ...
          <div className="mt-3 hidden lg:flex items-center gap-2">
            ...
            {/* we will be solve problem after same time */}
          ...
          {filteredUsers?.length > 0 && 
            ...
            {filteredUsers?.length === 0 && (
              <div className="text-center text-gray-500 py-4">
                {users?.length === 0 ? "No Users Found" : "No Online Users"}
              </div>
            )}
        </div>
      </aside>
